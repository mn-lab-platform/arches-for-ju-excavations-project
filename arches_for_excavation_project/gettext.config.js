...
module.exports = {
  input: {
    path: "./arches_for_excavation/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_for_excavation/locale", // output path of all created files
