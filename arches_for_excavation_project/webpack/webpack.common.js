        ...
        resolve({
            ...
            resolve: {
                ...
                alias: {
                    ...
                    // Add Cesium-specific jQuery resolution
                    '/arches_app/arches_for_excavation/node_modules/jquery/dist/jquery.min': Path.resolve(__dirname, PROJECT_RELATIVE_NODE_MODULES_PATH, 'jquery', 'dist', 'jquery.min.js'),
