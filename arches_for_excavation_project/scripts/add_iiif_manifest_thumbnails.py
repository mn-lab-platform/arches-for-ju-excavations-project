...
By default it scans arches_for_excavation/uploadedfiles/iiif_raster, where generated
...
def main() -> int:
    ...
    default_root = project_root / "arches_for_excavation" / "uploadedfiles" / "iiif_raster"
